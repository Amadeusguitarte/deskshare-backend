...
class ChatManager {
    ...
    renderMessageHTML(sortedMessages, user) {
        ...
        // This is used to ensure "Enviado/Visto" only appears once at the very end.
        ...
        `).join('');
            ...
            `;
                ...
                // Status Logic (Strict: Only Last Message of ME)
                // "Enviado" -> "Enviado hace X" (Relative)
                // "Visto" -> "Visto"
                let statusHtml = '';
                
                // Check if this is the ABSOLUTE last message sent by me in the entire sorted list
                // We calculated lastMyMsgId at the top
